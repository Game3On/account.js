...
/**
  ...
  */
contract SimpleTokenAccount is BaseAccount, UUPSUpgradeable, Initializable {
    ...
    constructor(IEntryPoint anEntryPoint, IERC20 token, address paymaster) {
        _entryPoint = anEntryPoint;
        // require(anOwner != address(0), 'ACL: Owner cannot be zero');

        // approve paymaster
        require(token.approve(paymaster, type(uint256).max));
    }
